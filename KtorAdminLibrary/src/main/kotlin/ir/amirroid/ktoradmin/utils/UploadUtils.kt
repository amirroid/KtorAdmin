...
object UploadUtils {
    ...
    fun hasUploadAnnotation(annotations: Sequence<KSAnnotation>): Boolean =
        annotations.any {
    ...
    fun getAllowedMimeTypesFromAnnotation(annotations: Sequence<KSAnnotation>): List<String>? =
        annotations
            .find { it.shortName.asString() == AllowedMimeTypes::class.simpleName }
            ?.arguments
    ...
    fun validatePropertyType(
        columnType: String,
        columnName: String,
    ): Boolean {
        if (columnType != "kotlin.String") {
            throw IllegalArgumentException(
                "Column '$columnName' must be of type 'kotlin.String' for file uploads. Only properties of type 'kotlin.String' are allowed for file uploads.",
            )
        }
        return true
    }
    ...
    fun validatePropertyType(
        ...
        if (fieldType != FieldType.String) {
            throw IllegalArgumentException(
                "Field '$fieldType' must be of type 'kotlin.String' for file uploads. Only properties of type 'kotlin.String' are allowed for file uploads.",
            )
        }
        return true
    }
