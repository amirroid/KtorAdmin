package ir.amirroid.ktoradmin.models.types
...
sealed class FieldType(
    ...
    data class Map(
        val fields: kotlin.collections.List<FieldSet>,
    ) : FieldType("MAP", "map")
    ...
    companion object {
        ...
        fun fromName(name: kotlin.String?): FieldType? = entries.firstOrNull { it.name == name }
    }
}

fun FieldType.toSuitableStringForFile(): String =
    when (this) {
        is FieldType.Map ->
            "Map(${
                fields.joinToString(
