...
import ir.amirroid.ktoradmin.getters.getSelectedReferencesItems
...
internal suspend fun ApplicationCall.handleJdbcEditView(
    ...
    if (data == null) {
        ...
        runCatching {
            ...
            val referencesItems =
                getReferencesItems(panels.filterIsInstance<AdminJdbcTable>(), panelColumnsList)
            val selectedReferences =
                getSelectedReferencesItems(
                    table,
                    panels.filterIsInstance<AdminJdbcTable>(),
                    primaryKey,
                )
            ...
            val values =
                errorValues?.takeIf { it.isNotEmpty() } ?: processColumnValues(
                    columns,
                    data,
                    this,
                )
...
suspend fun handleColumnPreviewValue(
    columnSet: ColumnSet,
    value: String,
...
suspend fun handleFieldPreviewValue(
    fieldSet: FieldSet,
    value: String,
    call: ApplicationCall,
) = when (fieldSet.type) {
