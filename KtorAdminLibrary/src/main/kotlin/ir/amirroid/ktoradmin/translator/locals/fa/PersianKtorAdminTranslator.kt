...
object PersianKtorAdminTranslator : KtorAdminTranslator() {
    ...
    override val translates: Map<String, String> =
        mapOf(
            ...
            Keys.ACTIONS to "اقدامات",
            Keys.CONFIRM_ACTION_TITLE to "تأیید اقدام",
            Keys.CONFIRM_ACTION_MESSAGE to "آیا مطمئن هستید که می‌خواید '{action}' را اجرا کنید؟ این عمل قابل بازگشت نیست.",
            Keys.CONFIRM to "تأیید",
            Keys.CANCEL to "لغو",
